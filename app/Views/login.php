                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" novalidate action="<?= base_url('home/aksilogin')?>" method="POST" onsubmit="return validateForm();">
                                <div class="form-group position-relative has-icon-left">
                                    <label for="username" style="font-weight: 500; color: #6c757d;">Email</label>
                                    <div class="position-relative">
                                        <input type="email" class="form-control" id="nama" name="nama" required style="border-radius: 10px;">
